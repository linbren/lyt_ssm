        ...
        <ul class="sidebar-menu">
            ...
            <#if funcs??>
                <#list funcs as func>
                     <li class="treeview">
                        <a href="#">
                            <i class="fa fa-envelope"></i> <span>${func.funcName!}</span> <span class="pull-right-container"> <i
                                class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <#if func.child??>
                            <ul class="treeview-menu">
                            <#list func.child as child>
                                <li>
                                    <a target="navTab" <#if child.funcUrl="druid" || child.funcUrl="doc.html"||child.funcUrl="swagger-ui.html"> target_type="iframe" fresh="false" </#if>href="${child.funcUrl!}">
                                        <i class="fa fa-inbox"></i> <span>${child.funcName!}</span>
                                    </a>
                                </li>
                            </#list>
                            </ul>                       
...
<header class="main-header">
    <a href="index2.html" class="logo">
        ...
        <span class="logo-lg"><b>frm</b></span>
    </a>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017-2026 <a href="https://github.com/linbren">frm</a>.
