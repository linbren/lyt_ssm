...
public class ServletUtils {
	...
	public static String buildRs(boolean success, String msg, Object obj) {
		...
		strb.append(success ? "1" : "0").append(",\"message\":\"")
				.append(null == msg ? "" : msg).append("\",\"datas\":")
				.append(null == obj ? "{}" : JSON.toJSONString(obj))
				.append("}");
	...
	public static String rsAndroid(boolean success, String msg, Object obj) {
		...
		strb.append(success ? "1" : "0").append(",\"result\":\"")
				.append(null == msg ? "" : msg).append("\",\"body\":")
				.append(null == obj ? "{}" : JSON.toJSONString(obj))
				.append("}");
